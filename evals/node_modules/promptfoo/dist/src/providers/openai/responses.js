    ...
    getOpenAiBody(prompt, context, callApiOptions) {
        ...
        if (config.response_format) {
            if (config.response_format.type === 'json_object') {
                ...
                const schema = (0, util_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(config.response_format.schema || config.response_format.json_schema?.schema, context?.vars));
