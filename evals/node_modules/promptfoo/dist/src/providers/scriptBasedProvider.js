...
exports.createScriptBasedProviderFactory = createScriptBasedProviderFactory;
    ...
    return {
        test: (providerPath) => {
            ...
            if (fileExtension && providerPath.startsWith('file://')) {
                return (providerPath.endsWith(`.${fileExtension}`) || providerPath.includes(`.${fileExtension}:`));
            }
            return false;
        },
        create: async (providerPath, providerOptions, context) => {
            ...
            const resolvedPath = (0, file_1.getResolvedRelativePath)(scriptPath, context.basePath, isCloudConfig);
            return new providerConstructor(resolvedPath, providerOptions);
        },
    };
}
//# sourceMappingURL=scriptBasedProvider.js.map