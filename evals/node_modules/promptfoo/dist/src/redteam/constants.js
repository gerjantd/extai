...
exports.OWASP_LLM_RED_TEAM_MAPPING = {
    ...
    'owasp:llm:redteam:model': {
        plugins: [...exports.FOUNDATION_PLUGINS],
        strategies: [
            'jailbreak',
            'jailbreak:tree',
            'jailbreak:composite',
...
exports.subCategoryDescriptions = {
    ...
    'other-encodings': 'Tests handling of content encoded with various encodings to potentially bypass filters',
    ...
    'tool-discovery:multi-turn': 'Uses conversational approach to discover available tools, functions, and capabilities through multi-step interactions',
