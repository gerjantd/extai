 ...
 */
export declare function synthesize({ abortSignal, delay, entities: entitiesOverride, injectVar, language, maxConcurrency, plugins, prompts, provider, purpose: purposeOverride, strategies, targetLabels, showProgressBar: showProgressBarOverride, }: SynthesizeOptions): Promise<{
    purpose: string;
    entities: string[];
