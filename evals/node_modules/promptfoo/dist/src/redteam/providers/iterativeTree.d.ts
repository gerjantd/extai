 ...
 */
export declare function evaluateResponse(redteamProvider: ApiProvider, judgeSystemPrompt: string, targetResponse: string, previousBestResponse: string, containsPenalizedPhrase: boolean): Promise<{
    score: number;
    explanation: string;
}>;
/**
 ...
 */
export declare function updateRedteamHistory(targetResponse: string, goal: string, score: number, isOnTopic: boolean, containsPenalizedPhrase: boolean, explanation?: string): {
    role: 'user' | 'assistant' | 'system';
    content: string;
};
/**
 ...
 */
export declare function runRedteamConversation({ context, filters, injectVar, options, prompt, redteamProvider, targetProvider, test, vars, }: {
